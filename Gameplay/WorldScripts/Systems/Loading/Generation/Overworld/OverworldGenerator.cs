...
using FainCraft.Gameplay.WorldScripts.Systems.Loading.Generation.Overworld.Biomes;
using static FainCraft.Gameplay.WorldScripts.WorldConstants;

namespace FainCraft.Gameplay.WorldScripts.Systems.Loading.Generation.Overworld
{
    internal class OverworldGenerator : ITerrainGenerator
    {
        ...
        public OverworldGenerator(IServiceProvider provider, int seed = 1337)
        {
            var indexer = provider.Get<IVoxelIndexer>();
        ...
        public RegionGenerationResult Generate(RegionCoord regionCoord)
        {
            ...
            // UpdateMesh the surrounding biomes
